...
urlpatterns = [
    ...
    path('edit/order/<int:orderId>/',
         views.OrderUpdateView.as_view(), name='edit-order'),
    path('userList/order/<str:username>/',
         views.UserOrderslist.as_view(), name='userOrdersList'),
    path('get/order/<int:order_id>/', views.GetOrder.as_view(), name='get_order'),
    path('Delete/order/<int:orderId>/',
